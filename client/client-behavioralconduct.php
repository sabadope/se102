...
<body>
    ...
    <script>
        ...
        if (
            ...
            path.includes("client-behavioralconduct.php") // 👈 Add this line
            
        ) {
            const menuId = (path.includes("client-performance.php") || path.includes("client-behavioralconduct.php"))
                ? '#performance-submenu'
                : '#activities-submenu';
        ...
        if (path.includes("client-skilldevelopment.php")) {
            const skillLink = document.querySelector('.sub-menu li a[href="client-behavioralconduct.php"]');
            if (skillLink) {
