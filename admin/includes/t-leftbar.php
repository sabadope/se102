<div class="left-sidebar bg-black-300 box-shadow ">
    <div class="sidebar-content">
        <div class="user-info closed">
            <img src="uploads/arimi.jpg" alt="John Doe" class="img-circle profile-img">
            ...
            <ul class="side-nav color-gray">
                ...
                <li class="has-children">
                    ...
                    <ul class="child-nav">
                        ...
                        <li><a href="create-subject-combination.php"><i class="fa fa-bars"></i> <span>Create Subject Combination Code</span></a></li>
                ...
                <li class="has-children">
                    <a href="#"><i class="fa fa-file-text"></i> <span>TimeTable</span> <i class="fa fa-angle-right arrow"></i></a>
                    <ul class="child-nav">
                        <li><a href="add-timetable-entry.php"><i class="fa fa-bars"></i> <span>Add TimeTable Entry</span></a></li>
                        <li><a href="manage-timetable.php"><i class="fa fa fa-server"></i> <span>Manage Timetable Entry</span></a></li>
                    </ul>
                </li>
                <li class="has-children">
                    <a href="#"><i class="fa fa-file-text"></i> <span>Exam</span> <i class="fa fa-angle-right arrow"></i></a>
                    <ul class="child-nav">
                        <li><a href="add-exam-period.php"><i class="fa fa-bars"></i> <span>Add Exam Period</span></a></li>
                        <li><a href="manage-exam-period.php"><i class="fa fa fa-server"></i> <span>Manage Exam Period</span></a></li>
                        <li><a href="exam-results.php"><i class="fa fa fa-server"></i> <span>Exam Results</span></a></li>
                ...
                <li class="has-children">
                    <a href="#"><i class="fa fa-inbox"></i> <span>Messages</span> <i class="fa fa-angle-right arrow"></i></a>
                    <ul class="child-nav">
                        <li><a href="add-recipients.php"><i class="fa fa-bars"></i> <span>Send Message</span></a></li>
                        <li><a href="manage-teachers.php"><i class="fa fa fa-server"></i> <span>Manage Teachers</span></a></li>
