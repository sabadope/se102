...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-2 sidebar min-vh-100 bg-dark text-white p-3">
                <a href="jay-intern-view.php" class="d-block text-white py-2">Task Management</a>
                <a href="jay-view-task-intern.php" class="d-block text-white py-2">View Task</a>
    ...
    <script>
        ...
        function fetchTasks() {
            $.ajax({
                url: 'jay-fetch-intern-tasks.php',
                method: 'GET',
        ...
        $(document).on('change', '.task-status', function() {
            ...
            $.ajax({
                url: 'jay-update-task-status.php',
                method: 'POST',
