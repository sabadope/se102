...
<body class="top-navbar-fixed">
                                                    ...
                                                    if ($query->rowCount() > 0) {
                                                        foreach ($results as $result) { ?>
                                                            <tr>
                                                                ...
                                                                <!-- <td>
                                                                    <a href="#" class="btn btn-primary view-edit-results" data-rollid="<?php echo htmlentities($result->RollId); ?>">
                                                                        View/Edit Results
                                                                    </a>-->
                                                                </td>
                                                            </tr>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- Use iframe to include add-result.php with the specific RollId -->
                        <iframe id="iframe<?php echo htmlentities($result->RollId); ?>" src="edit-results.php?rollid=<?php echo htmlentities($result->RollId); ?>" width="100%" height="520px" frameborder="0"></iframe>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('a.view-edit-results').click(function (e) {
                e.preventDefault();
