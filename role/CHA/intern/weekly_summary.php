            ...
            <div class="card-body">
                ...
                <div id="intern" class="tab-content active">
                    ...
                    <?php if ($result && $result->num_rows > 0): ?>
                        ...
                        <div class="action-buttons">
                            ...
                            <button onclick="window.location.href='export_weekly.php?start_date=<?= $monday ?>&end_date=<?= $sunday ?>'" 
                ...
                <div id="supervisor" class="tab-content">
                    <div class="review-container">
                        ...
                        <form action="save_supervisor_review.php" method="POST" class="review-form">
