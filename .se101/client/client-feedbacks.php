...
<body>
    ...
    <script>
        ...
        if (
            ...
            path.includes("client-feedbacks.php") // 👈 Add this line

        ) {
            const menuId = (path.includes("client-performance.php") || path.includes("client-feedbacks.php"))
                ? '#performance-submenu'
                : '#activities-submenu';
        ...
        if (path.includes("client-feedbacks.php")) {
            const skillLink = document.querySelector('.sub-menu li a[href="client-feedbacks.php"]');
            if (skillLink) {
