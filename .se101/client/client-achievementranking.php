...
<body>
    ...
    <script>
        ...
        if (
            ...
            path.includes("client-achievementranking.php") // 👈 Add this line
            
        ) {
            const menuId = (path.includes("client-performance.php") || path.includes("client-achievementranking.php"))
                ? '#performance-submenu'
                : '#activities-submenu';
        ...
        if (path.includes("client-skilldevelopment.php")) {
            const skillLink = document.querySelector('.sub-menu li a[href="client-achievementranking.php"]');
            if (skillLink) {
