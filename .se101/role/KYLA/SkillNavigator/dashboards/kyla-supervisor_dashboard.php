...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="mt-4">
            <a href="../skills/kyla-evaluate_skill.php" class="inline-block bg-purple-500 hover:bg-purple-600 text-white font-bold py-2 px-4 rounded transition duration-300">
                Evaluate Interns
            </a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <?php endif; ?>
        <div class="mt-4">
            <a href="../skills/kyla-evaluate_skill.php" class="text-sm text-purple-600 hover:text-purple-800 font-medium">
                View all skills →
            </a>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <?php foreach ($interns as $intern): ?>
                <div class="border rounded-lg p-4 hover:bg-gray-50 transition duration-200">
                    ...
                    <div class="mt-3">
                        <a href="../skills/kyla-evaluate_skill.php?intern_id=<?php echo $intern['id']; ?>" 
