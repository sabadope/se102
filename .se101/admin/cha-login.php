...
$hardcoded_password_plain = 'admin1230';
$hardcoded_password_hash = '$2y$10$YVGcFYmtzk9XUpJrKXxz7OAwfQ4Zd/JJk7c8el6Xuvrq8U1RB1D4C'; // Keep it if you need to verify against hash

if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $email = $conn->real_escape_string($_POST['email']);
    $password = $_POST['password'];

    // Check if logging in as the hardcoded admin
