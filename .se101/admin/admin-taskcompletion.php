...
<body>
    ...
    <script>
        ...
        if (
            ...
            path.includes("admin-taskcompletion.php") // 👈 Add this line
            
        ) {
            const menuId = (path.includes("admin-performance.php") || path.includes("admin-taskcompletion.php"))
                ? '#performance-submenu'
                : '#activities-submenu';
        ...
        if (path.includes("admin-skilldevelopment.php")) {
            const skillLink = document.querySelector('.sub-menu li a[href="admin-taskcompletion.php"]');
            if (skillLink) {
