...
<body>
    ...
    <script>
        ...
        if (
            ...
            path.includes("admin-behavioralconduct.php") // 👈 Add this line
            
        ) {
            const menuId = (path.includes("admin-performance.php") || path.includes("admin-behavioralconduct.php"))
                ? '#performance-submenu'
                : '#activities-submenu';
        ...
        if (path.includes("admin-skilldevelopment.php")) {
            const skillLink = document.querySelector('.sub-menu li a[href="admin-behavioralconduct.php"]');
            if (skillLink) {
