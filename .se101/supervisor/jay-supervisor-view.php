    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-2 sidebar min-vh-100 bg-dark text-white p-3">
                <a href="jay-supervisor-view.php" class="d-block text-white py-2">Task Management</a>
                <a href="jay-assign-task.php" class="d-block text-white py-2">Assign Task</a>
                <a href="jay-view-task.php" class="d-block text-white py-2">View Task</a>

                <a href="jay-login.php" class="d-block text-danger py-2">Log out</a>
            </div>
                    ...
                    tasks.forEach(task => {
                        ...
                        taskRows += `
                            <tr>
                                ...
                                <td>${task.deadline}</td>
                                <td>
                                    <form action="jay-rate-task.php" method="POST">
                                ...
                                <td>
                                    <form action="jay-feedback-task.php" method="POST">
                                        <input type="hidden" name="task_id" value="${task.id}">
