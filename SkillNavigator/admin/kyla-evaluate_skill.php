...
<div class="bg-white rounded-lg shadow-md p-6 mb-8">
    ...
    <form method="GET" action="kyla-evaluate_skill.php">
...
<div id="assignTaskModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center hidden z-50">
    <div class="bg-white rounded-lg shadow-xl max-w-lg w-full p-6">
        ...
        <form action="kyla-evaluate_skill.php" method="POST">
        ...
        <div class="space-y-6">
            <?php foreach ($technical_skills as $skill): ?>
                <div class="border rounded-lg p-4">
                    ...
                    <form action="kyla-evaluate_skill.php" method="POST" class="mt-4 p-4 bg-gray-50 rounded-md">
