...
<div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="grid grid-cols-2 gap-2">
            <a href="../kyla-register.php" class="inline-block bg-red-500 hover:bg-red-600 text-white text-center font-bold py-2 px-4 rounded transition duration-300">
                Add User
            </a>
            <a href="../reports/kyla-generate_report.php" class="inline-block bg-blue-500 hover:bg-blue-600 text-white text-center font-bold py-2 px-4 rounded transition duration-300">
                Reports
            </a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="space-y-2">
            <a href="../kyla-register.php?role=intern" class="block p-3 bg-gray-100 hover:bg-gray-200 rounded transition duration-200">
                <div class="font-medium text-gray-800">Add New Intern</div>
                <div class="text-xs text-gray-500">Create intern account</div>
            </a>
            <a href="../kyla-register.php?role=supervisor" class="block p-3 bg-gray-100 hover:bg-gray-200 rounded transition duration-200">
                <div class="font-medium text-gray-800">Add New Supervisor</div>
                <div class="text-xs text-gray-500">Create supervisor account</div>
            </a>
            <a href="../reports/kyla-generate_report.php" class="block p-3 bg-gray-100 hover:bg-gray-200 rounded transition duration-200">
                <div class="font-medium text-gray-800">Generate Reports</div>
                <div class="text-xs text-gray-500">View skill analytics</div>
            </a>
            <a href="../reports/kyla-export_pdf.php" class="block p-3 bg-gray-100 hover:bg-gray-200 rounded transition duration-200">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <?php else: ?>
            ...
            <div class="mt-4 text-right">
                <a href="../reports/kyla-generate_report.php" class="text-sm text-blue-600 hover:text-blue-800 font-medium">
                    View Full Report →
                </a>
            </div>
        <?php endif; ?>
...
<div class="bg-white rounded-lg shadow-md p-6 mb-8">
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="../kyla-register.php" class="bg-blue-500 hover:bg-blue-600 text-white text-sm font-bold py-2 px-4 rounded transition duration-300">
            Add New User
        </a>
    </div>
