...
<body>
            ...
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a class="active">Task Completion</a>
                        </li>
                    </ul>
                </div>
    ...
    <script>
        ...
        if (
            ...
            path.includes("supervisor-taskcompletion.php") // 👈 Add this line
            
        ) {
            const menuId = (path.includes("supervisor-performance.php") || path.includes("supervisor-taskcompletion.php"))
                ? '#performance-submenu'
                : '#activities-submenu';
        ...
        if (path.includes("supervisor-skilldevelopment.php")) {
            const skillLink = document.querySelector('.sub-menu li a[href="supervisor-taskcompletion.php"]');
            if (skillLink) {
