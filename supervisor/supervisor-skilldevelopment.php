...
<body>
        ...
        <main>
            ...
            <div class="table-data">
                ...
                <div class="chat-container" style="overflow-x: hidden;">
                    ...
                    <iframe src="kyla-logout.php" max-width="980px" width="980px" height="600px" frameborder="0" style="overflow-x: hidden;"></iframe>
    ...
    <script>
        ...
        if (
            ...
            path.includes("supervisor-skilldevelopment.php") // 👈 Add this line

        ) {
            const menuId = (path.includes("supervisor-performance.php") || path.includes("supervisor-skilldevelopment.php"))
                ? '#performance-submenu'
                : '#activities-submenu';
        ...
        if (path.includes("supervisor-skilldevelopment.php")) {
            const skillLink = document.querySelector('.sub-menu li a[href="supervisor-skilldevelopment.php"]');
            if (skillLink) {
